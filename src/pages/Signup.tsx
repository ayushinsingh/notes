    ...
    <div className="min-h-screen flex justify-center items-center margin-auto bg-neutral-100 dark:bg-neutral-700">
      <Card>
        ...
        <div className= "w-full flex flex-col gap-2">
          ...
          <p className="text-center text-xs text-gray-500 dark:text-neutral-300">Signup to start organizing your notes and boost your productivity.</p>
        </div>
        <form className="w-full flex flex-col gap-4" onSubmit={(e) => {
          ...
          <PasswordInput id="password" label="Password" helperText="At least 8 characters" />
